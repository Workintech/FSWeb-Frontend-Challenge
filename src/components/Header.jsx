    ...
    return(
        ...
        <header className="flex justify-end px-10 pb-8 pt-20 md:px-60" >
            <label className="inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" className="sr-only peer" checked={theme} onChange={toggleTheme}/>
                ...
                <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">{theme === "dark" ? "LIGHT MODE" : "DARK MODE"}</span>
            </label>
            <p className="px-4"> | </p>
            <LanguageToggle/>
        </header>
